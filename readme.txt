...
Tags: easy digital downloads, digital, download, downloads, edd, tsunoa, rubengc, link, security, restriction, protection, secure, e-commerce
...
Automatically add extra security to download file links.

== Description ==
EDD Download Link Security adds own download file verification process based on this checks:
